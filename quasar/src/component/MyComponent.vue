...
const { fontSize = '5xl' } = defineProps<{
  /**
  ...
  testProp: string;
  /**
   * Does this comment show on UI?
   * @deprecated since 250311
   */
  anotherProp?: number;
  fontSize: keyof typeof titleFontClassMap;
}>();
</script>
...
<template>
  ...
  <div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-4xl text-center">
      ...
      <p
        :class="`mt-2 ${titleFontClassMap[fontSize]} font-semibold tracking-tight text-balance text-gray-900`"
      >
